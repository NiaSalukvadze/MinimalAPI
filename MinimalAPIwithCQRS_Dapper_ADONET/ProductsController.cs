...
using MinimalAPIwithCQRS_Dapper_ADONET.CQRS.Commands.CreateProductCommand;
using MinimalAPIwithCQRS_Dapper_ADONET.CQRS.Commands.DeleteProductCommand;
using MinimalAPIwithCQRS_Dapper_ADONET.CQRS.Commands.UpdateProductCommand;
using MinimalAPIwithCQRS_Dapper_ADONET.CQRS.Queries.GetProducts;

namespace MinimalAPIwithCQRS_Dapper_ADONET
{
