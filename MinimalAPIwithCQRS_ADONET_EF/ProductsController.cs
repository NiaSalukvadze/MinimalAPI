...
using MinimalAPIwithCQRS_ADONET_EF.CQRS.Commands.CreateProductCommand;
using MinimalAPIwithCQRS_ADONET_EF.CQRS.Commands.DeleteProductCommand;
using MinimalAPIwithCQRS_ADONET_EF.CQRS.Commands.UpdateProductCommand;
using MinimalAPIwithCQRS_ADONET_EF.CQRS.Queries.GetProducts;

namespace MinimalAPIwithCQRS_ADONET_EF
{
